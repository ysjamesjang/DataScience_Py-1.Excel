...
* **Color-coded Conditional Formatting based on Campaign Outcome** <br>
(Successful; Failed; Canceled; Currently Live) 

* **Three-color Scale Conditional Formatting based on Percent Funded** <br>
(Red: 0%; Green: 100%; Blue: 200%)

* **Average Donation of Backers in USD**

* **String Split by Delimiter for Category and Subcategory Classification**

* **Pivot Table: Campaign Outcome Count by Category**

* **Pivot Table: Campaign Outcome Count by Subcategory**

* **Stacked Column Pivot Chart Filtered by Country and Parent-Category**
